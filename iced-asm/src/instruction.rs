...
impl Instruction {
    ...
    pub fn code_size(&self) -> CodeSize {
        unsafe {
            mem::transmute(
                ((self.flags1 >> InstrFlags1::CODE_SIZE_SHIFT) & InstrFlags1::CODE_SIZE_MASK)
    ...
    pub fn set_code_size(&mut self, new_value: CodeSize) {
        self.flags1 = (self.flags1
            & !(InstrFlags1::CODE_SIZE_MASK << InstrFlags1::CODE_SIZE_SHIFT))
    ...
    pub const fn has_segment_prefix(&self) -> bool {
        ((self.flags1 >> InstrFlags1::SEGMENT_PREFIX_SHIFT) & InstrFlags1::SEGMENT_PREFIX_MASK)
            .wrapping_sub(1)
            < 6
    }
    ...
    pub fn segment_prefix(&self) -> Register {
        let index = ((self.flags1 >> InstrFlags1::SEGMENT_PREFIX_SHIFT)
            & InstrFlags1::SEGMENT_PREFIX_MASK)
            .wrapping_sub(1);
    ...
    pub fn set_segment_prefix(&mut self, new_value: Register) {
        debug_assert!(
            new_value == Register::None || (Register::ES <= new_value && new_value <= Register::GS)
        );
        let enc_value = if new_value == Register::None {
            0
        } else {
            (((new_value as u32) - (Register::ES as u32)) + 1) & InstrFlags1::SEGMENT_PREFIX_MASK
        };
        self.flags1 = (self.flags1
            & !(InstrFlags1::SEGMENT_PREFIX_MASK << InstrFlags1::SEGMENT_PREFIX_SHIFT))
    ...
    pub fn memory_segment(&self) -> Register {
        ...
        match self.memory_base() {
            Register::BP | Register::EBP | Register::ESP | Register::RBP | Register::RSP => {
                Register::SS
            }
            _ => Register::DS,
        }
    ...
    pub fn mvex_reg_mem_conv(&self) -> MvexRegMemConv {
        if !IcedConstants::is_mvex(self.code()) {
            ...
            <MvexRegMemConv as core::convert::TryFrom<_>>::try_from(
                ((self.immediate >> MvexInstrFlags::MVEX_REG_MEM_CONV_SHIFT)
                    & MvexInstrFlags::MVEX_REG_MEM_CONV_MASK) as usize,
            )
            .ok()
            .unwrap_or_default()
        }
    ...
    pub fn set_mvex_reg_mem_conv(&mut self, new_value: MvexRegMemConv) {
        self.immediate = (self.immediate
            & !(MvexInstrFlags::MVEX_REG_MEM_CONV_MASK << MvexInstrFlags::MVEX_REG_MEM_CONV_SHIFT))
    ...
    pub fn memory_size(&self) -> MemorySize {
        ...
        #[cfg(feature = "mvex")]
        {
            if IcedConstants::is_mvex(code) {
                ...
                const _: () = assert!(
                    MvexRegMemConv::MemConvNone as u32 + 1
                        == MvexRegMemConv::MemConvBroadcast1 as u32
                );
                const _: () = assert!(
                    MvexRegMemConv::MemConvNone as u32 + 2
                        == MvexRegMemConv::MemConvBroadcast4 as u32
                );
                const _: () = assert!(
                ...
                let sss = ((self.mvex_reg_mem_conv() as u32)
                    .wrapping_sub(MvexRegMemConv::MemConvNone as u32)
                    & 7) as usize;
                return crate::mvex::mvex_memsz_lut::MVEX_MEMSZ_LUT
    ...
    pub fn set_op_mask(&mut self, new_value: Register) {
        debug_assert!(
            new_value == Register::None || (Register::K1 <= new_value && new_value <= Register::K7)
        );
        let r = if new_value == Register::None {
            0
        } else {
            (new_value as u32 - Register::K0 as u32) & InstrFlags1::OP_MASK_MASK
        };
        self.flags1 = (self.flags1 & !(InstrFlags1::OP_MASK_MASK << InstrFlags1::OP_MASK_SHIFT))
    ...
    pub fn rounding_control(&self) -> RoundingControl {
        unsafe {
            mem::transmute(
                ((self.flags1 >> InstrFlags1::ROUNDING_CONTROL_SHIFT)
                    & InstrFlags1::ROUNDING_CONTROL_MASK)
                    as RoundingControlUnderlyingType,
            )
        }
    }
    ...
    pub fn set_rounding_control(&mut self, new_value: RoundingControl) {
        self.flags1 = (self.flags1
            & !(InstrFlags1::ROUNDING_CONTROL_MASK << InstrFlags1::ROUNDING_CONTROL_SHIFT))
    ...
    pub const fn declare_data_len(&self) -> usize {
        (((self.flags1 >> InstrFlags1::DATA_LENGTH_SHIFT) & InstrFlags1::DATA_LENGTH_MASK) + 1)
            as usize
    }
    ...
    pub fn set_declare_data_len(&mut self, new_value: usize) {
        ...
        self.flags1 = (self.flags1
            & !(InstrFlags1::DATA_LENGTH_MASK << InstrFlags1::DATA_LENGTH_SHIFT))
            | ((((new_value as u32) - 1) & InstrFlags1::DATA_LENGTH_MASK)
                << InstrFlags1::DATA_LENGTH_SHIFT);
    }
    ...
    pub fn try_set_declare_byte_value(
        ...
        match index {
            ...
            9 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_FFFF_FFFF_00FF) | ((new_value as u64) << 8)
            }
            10 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_FFFF_FF00_FFFF) | ((new_value as u64) << 16)
            }
            11 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_FFFF_00FF_FFFF) | ((new_value as u64) << 24)
            }
            12 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_FF00_FFFF_FFFF) | ((new_value as u64) << 32)
            }
            13 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_00FF_FFFF_FFFF) | ((new_value as u64) << 40)
            }
            14 => {
                self.mem_displ =
                    (self.mem_displ & 0xFF00_FFFF_FFFF_FFFF) | ((new_value as u64) << 48)
            }
            15 => {
                self.mem_displ =
                    (self.mem_displ & 0x00FF_FFFF_FFFF_FFFF) | ((new_value as u64) << 56)
            }
    ...
    pub fn try_set_declare_word_value(
        ...
        match index {
            ...
            5 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_FFFF_0000_FFFF) | ((new_value as u64) << 16)
            }
            6 => {
                self.mem_displ =
                    (self.mem_displ & 0xFFFF_0000_FFFF_FFFF) | ((new_value as u64) << 32)
            }
            7 => {
                self.mem_displ =
                    (self.mem_displ & 0x0000_FFFF_FFFF_FFFF) | ((new_value as u64) << 48)
            }
            _ => return Err(IcedError::new("Invalid index")),
        }
        Ok(())
    ...
    pub fn try_set_declare_dword_value(
        ...
        match index {
            ...
            3 => {
                self.mem_displ = (self.mem_displ & 0x0000_0000_FFFF_FFFF) | (new_value as u64) << 32
            }
            _ => return Err(IcedError::new("Invalid index")),
        }
        Ok(())
        ...
        Ok(match index {
            0 => {
                self.regs[0] as u32
                    ...
                    | ((self.regs[2] as u32) << 16)
                    | ((self.regs[3] as u32) << 24)
            }
            1 => self.immediate,
        ...
        F: FnMut(Register, usize, usize) -> Option<u64>,
    {
        ...
        Some(match op_kind {
            ...
            OpKind::MemorySegSI => get_register_value(self.memory_segment(), 0, 0)?
                .wrapping_add(get_register_value(Register::SI, 0, 0)? as u16 as u64),
            OpKind::MemorySegESI => get_register_value(self.memory_segment(), 0, 0)?
                .wrapping_add(get_register_value(Register::ESI, 0, 0)? as u32 as u64),
            OpKind::MemorySegRSI => get_register_value(self.memory_segment(), 0, 0)?
                .wrapping_add(get_register_value(Register::RSI, 0, 0)?),
            OpKind::MemorySegDI => get_register_value(self.memory_segment(), 0, 0)?
                .wrapping_add(get_register_value(Register::DI, 0, 0)? as u16 as u64),
            OpKind::MemorySegEDI => get_register_value(self.memory_segment(), 0, 0)?
                .wrapping_add(get_register_value(Register::EDI, 0, 0)? as u32 as u64),
            OpKind::MemorySegRDI => get_register_value(self.memory_segment(), 0, 0)?
                .wrapping_add(get_register_value(Register::RDI, 0, 0)?),
            OpKind::MemoryESDI => get_register_value(Register::ES, 0, 0)?
                .wrapping_add(get_register_value(Register::DI, 0, 0)? as u16 as u64),
            OpKind::MemoryESEDI => get_register_value(Register::ES, 0, 0)?
                .wrapping_add(get_register_value(Register::EDI, 0, 0)? as u32 as u64),
            OpKind::MemoryESRDI => get_register_value(Register::ES, 0, 0)?
                .wrapping_add(get_register_value(Register::RDI, 0, 0)?),
            OpKind::Memory => {
                let base_reg = self.memory_base();
                    ...
                    && !code.is_tile_stride_index()
                {
                    if let Some(is_vsib64) = self.vsib() {
                        ...
                        offset = offset.wrapping_add(
                            get_register_value(index_reg, 0, 0)?
                                << instruction_internal::internal_get_memory_index_scale(self),
                        );
                    }
                }
                ...
                {
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 1
                            == Code::MVEX_Vloadunpackhq_zmm_k1_mt as u32
                    );
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 2
                            == Code::MVEX_Vpackstorehd_mt_k1_zmm as u32
                    );
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 3
                            == Code::MVEX_Vpackstorehq_mt_k1_zmm as u32
                    );
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 4
                            == Code::MVEX_Vloadunpackhps_zmm_k1_mt as u32
                    );
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 5
                            == Code::MVEX_Vloadunpackhpd_zmm_k1_mt as u32
                    );
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 6
                            == Code::MVEX_Vpackstorehps_mt_k1_zmm as u32
                    );
                    const _: () = assert!(
                        Code::MVEX_Vloadunpackhd_zmm_k1_mt as u32 + 7
                            == Code::MVEX_Vpackstorehpd_mt_k1_zmm as u32
                    );
                    if code >= Code::MVEX_Vloadunpackhd_zmm_k1_mt
                        && code <= Code::MVEX_Vpackstorehpd_mt_k1_zmm
                    {
...
impl Instruction {
    ...
    fn rflags_info(&self) -> RflagsInfo {
        ...
        const _: () = assert!(
            ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32 + 1
                == ImpliedAccess::Shift_Ib_MASK1FMOD11 as u32
        );
        const _: () = assert!(
            ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32 + 2 == ImpliedAccess::Shift_Ib_MASK1F as u32
        );
        const _: () = assert!(
            ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32 + 3 == ImpliedAccess::Shift_Ib_MASK3F as u32
        );
        const _: () = assert!(
            ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32 + 4 == ImpliedAccess::Clear_rflags as u32
        );
        // SAFETY: The table is generated and only contains valid enum variants
        let result = unsafe {
            mem::transmute(
                ((flags1 >> InfoFlags1::RFLAGS_INFO_SHIFT) & InfoFlags1::RFLAGS_INFO_MASK) as u8,
            )
        };
        ...
        match e {
            0 | 1 => {
                #[allow(clippy::eq_op)]
                const _: () = assert!(
                    ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32
                        - ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32
                        == 0
                );
                const _: () = assert!(
            ...
            2 | 3 => {
                const _: () = assert!(
                    ImpliedAccess::Shift_Ib_MASK1F as u32
                        - ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32
                        == 2
                );
                const _: () = assert!(
                    ImpliedAccess::Shift_Ib_MASK3F as u32
                        - ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32
                        == 3
                );
            ...
            4 => {
                const _: () = assert!(
                    ImpliedAccess::Clear_rflags as u32 - ImpliedAccess::Shift_Ib_MASK1FMOD9 as u32
                        == 4
                );
                if self.op0_register() == self.op1_register()
                    && self.op0_kind() == OpKind::Register
                    && self.op1_kind() == OpKind::Register
                {
    ...
    impl Serialize for Instruction {
            ...
            S: Serializer,
        {
            if is_human_readable(serializer.is_human_readable()) {
                let mut serde_state =
                    serializer.serialize_struct("Instruction", NUM_FIELDS_READABLE)?;
                let mut fields = 0;
                ...
                let mut serde_state =
                    serializer.serialize_struct("Instruction", NUM_FIELDS_BINARY)?;
                let mut fields = 0;
                macro_rules! serialize {
                    ($field:ident) => {
                        serde_state.serialize_field(stringify!($field), &self.$field)?;
                    ...
                    ($field:ident, $index:literal, $underlying_ty:ty) => {
                        serde_state.serialize_field(
                            ...
                            &(self.$field[$index] as $underlying_ty),
                        )?;
                        fields += 1;
                    };
                }
    ...
    impl<'de> Deserialize<'de> for Instruction {
            ...
            D: Deserializer<'de>,
        {
            if is_human_readable(deserializer.is_human_readable()) {
                ...
                impl StructField {
                    #[inline]
                    fn values() -> impl Iterator<Item = StructField>
                           + DoubleEndedIterator
                           + ExactSizeIterator
                           + FusedIterator {
                        // SAFETY: all values 0-max are valid enum values
                        (0..NUM_FIELDS_READABLE)
                            .map(|x| unsafe { mem::transmute::<u8, StructField>(x as u8) })
                    }
                }
                                ...
                                match seq.next_element::<$field_ty>()? {
                                    ...
                                    None => {
                                        return Err(de::Error::invalid_length(
                                            fields,
                                            &"struct Instruction with all its fields",
                                        ))
                                    }
                                }
                            }};
                ...
                impl<'de> de::Visitor<'de> for Visitor<'de> {
                        ...
                        A: de::SeqAccess<'de>,
                    {
                        ...
                        macro_rules! next_element {
                            ...
                            ($field_name:ident : $field_ty:ty : $underlying_ty:ty) => {{
                                ...
                                if let Ok(enum_value) =
                                    <$field_ty as TryFrom<usize>>::try_from(value as usize)
                                {
                                    enum_value
                                } else {
                        ...
                        let instruction = Instruction {
                            ...
                            mem_base_reg: next_element!(
                                mem_base_reg: Register: RegisterUnderlyingType
                            ),
                            mem_index_reg: next_element!(
                                mem_index_reg: Register: RegisterUnderlyingType
                            ),
                            regs: [
                        ...
                        A: de::MapAccess<'de>,
                    {
                        ...
                        while let Some(field) = map.next_key::<StructField>()? {
                            ...
                            match field {
                                ...
                                StructField::mem_base_reg => {
                                    unpack!(mem_base_reg: Register: RegisterUnderlyingType)
                                }
                                StructField::mem_index_reg => {
                                    unpack!(mem_index_reg: Register: RegisterUnderlyingType)
                                }
                                StructField::regs0 => {
                                    unpack!(regs0: Register: RegisterUnderlyingType)
                                }
                                StructField::regs1 => {
                                    unpack!(regs1: Register: RegisterUnderlyingType)
                                }
                                StructField::regs2 => {
                                    unpack!(regs2: Register: RegisterUnderlyingType)
                                }
                                StructField::regs3 => {
                                    unpack!(regs3: Register: RegisterUnderlyingType)
                                }
                                StructField::op_kinds0 => {
                                    unpack!(op_kinds0: OpKind: OpKindUnderlyingType)
                                }
                                StructField::op_kinds1 => {
                                    unpack!(op_kinds1: OpKind: OpKindUnderlyingType)
                                }
                                StructField::op_kinds2 => {
                                    unpack!(op_kinds2: OpKind: OpKindUnderlyingType)
                                }
                                StructField::op_kinds3 => {
                                    unpack!(op_kinds3: OpKind: OpKindUnderlyingType)
                                }
                                StructField::scale => {
                                    unpack!(scale: InstrScale: InstrScaleUnderlyingType)
                                }
                                StructField::displ_size => unpack!(displ_size: u8),
                                StructField::len => unpack!(len: u8),
                                StructField::pad => unpack!(pad: u8),
                        ...
                        let instruction = Instruction {
                            ...
                            op_kinds: [
                                unpack_field!(op_kinds0),
                                unpack_field!(op_kinds1),
                                unpack_field!(op_kinds2),
                                unpack_field!(op_kinds3),
                            ],
                            scale: unpack_field!(scale),
                            displ_size: unpack_field!(displ_size),
                            len: unpack_field!(len),
