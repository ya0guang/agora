...
pub fn load_lucet_metadata(program: &ModuleData) -> VwMetadata {
    ...
    // TODO: Add these into start of the proof file, probably also validate when
    // loading the binary in validation step. To isolate lucet-dependent
    // patterns, maybe validate in policy matcher?
